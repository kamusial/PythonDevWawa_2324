# Form implementation generated from reading ui file '.\10_calc.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_1.clicked.connect(self.info)
    ...
    def mnozenie(self):
        ...
        liczba2 = float(self.lineEdit_2.text())
        suma = liczba1 * liczba2
        self.label_3.setText('mnozenie : {}'.format(suma))
    ...
    def info(self):
        self.label_4.setText('')
        if float(self.lineEdit.text()) > 10:
            self.label_4.setText('Duza liczba')
